...
| Key | Type | Required | Description & Best Practices | Example |
|-----|------|----------|------------------------------|---------|
...
> **Note**: These files are located in the [Documentation](https://github.com/abra-code/OMC/tree/master/Documentation) folder of the OMC GitHub repository.
